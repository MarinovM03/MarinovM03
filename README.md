...
# Hey, I'm Martin Marinov 👋

### Full-Stack JavaScript & TypeScript Developer

I build thoughtful, full-stack web applications with modern frontend frameworks, secure backend services, and a strong focus on user experience.
...
I'm a JavaScript and TypeScript developer who enjoys turning ideas into complete, responsive web applications.

I like taking projects beyond basic CRUD functionality by adding authentication, role-based access, external APIs, search, testing, accessibility, security, and the small UX details that make software pleasant to use.

I learn best by building, refining, and eventually shipping real projects.
...
A full-stack educational platform for learning about Bitcoin through articles, community-created content, interactive learning paths, quizzes, live market information, and practical Bitcoin tools.

Built with **React**, **TypeScript**, **Node.js**, **Express**, and **MongoDB**.

- Authentication, ownership rules, and role-based administration
- Learning paths, quizzes, certifications, articles, and glossary content
- Live market data and interactive Bitcoin tools
- Search, bookmarks, comments, drafts, profiles, and moderation
- Security hardening, rate limiting, sanitization, and responsive design

[![View Repository](https://img.shields.io/badge/View_Bitcoin_Learning_Hub-F7931A?style=for-the-badge&logo=bitcoin&logoColor=white)](https://github.com/MarinovM03/bitcoin-learning-hub)

---

## 🌱 Current Direction

- Building a complete Angular application using modern Angular architecture
- Strengthening my experience with signals, routing, forms, guards, interceptors, and testing
- Exploring NestJS for structured and scalable backend development
- Learning PostgreSQL and relational data modelling with Prisma
- Deploying projects earlier and improving them around real feedback
- Continuing to improve accessibility, security, performance, and automated testing
